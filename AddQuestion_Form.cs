...
namespace DB_Project_Examination
{
    public partial class AddQuestion_Form : Form
    {
        ...
        private void btn_addChoice_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Choices Add successfully");
        ...
        private void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (rtxt_qBody.Text != "" && rtxt_Choice.Text !="" && num_qGrade.Value !=0)
            {
                ...
                if (cb_qType.SelectedValue.ToString() == "TF")
                {
                    ...
                    MessageBox.Show("Question Add successfully");
            ...
            else
            {
                ...
                errProvider.SetError(rtxt_Choice, "Question Choice can't be empty");
