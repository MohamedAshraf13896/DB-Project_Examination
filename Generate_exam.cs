    ...
    public partial class Generate_exam : Form
    {
        ...
        private void btn_generate_ex_Click(object sender, EventArgs e)
        {
            ...
            if ((_N_MCQ + _N_TF) != 12)
            {
                ...
                errorProvider1.SetError(date_exam, "Maxmimum Questions = 12!");
            }
            else
            {
                ...
                if (_duo_ex < 0 || _duo_ex > 3)
                {
                    ...
                    errorProvider1.SetError(date_exam, "Please Enter a Valid exam duration!");
        ...
        private void cb_crs_id_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        {
            var question = _Context.Questions.Where(q => q.crs_id == (int)cb_crs_id.SelectedValue && q.exam_id == (int)cb_crs_id.SelectedValue);
            ...
            {
                string message2 = "Do you want to assign the date of the exam exam?";
